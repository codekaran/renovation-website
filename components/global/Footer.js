...
const SocialIcons = () => {
  return (
    <div className={style.social}>
      <p className={style.name}>S. Smith</p>
  ...
  return (
    <div className={style.address}>
      ...
      <p className={style.info}>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit ut habitant
        eget ut nunc. Consequat quis senectus praesent vitae, nibh sit faucibus
        massa. Integer blandit quisque rutrum quis mauris blandit amet.
      </p>
    </div>
  );
};
